...
public class PlayerStatsSelect {

    private final CqlSession session;

    public PlayerStatsSelect(CqlSession session) {
    ...
    private String determineTable(String statsType) {
        ...
        return (firstChar >= 'A' && firstChar <= 'M') ? "player_data.player_stats_a_m" : "player_data.player_stats_n_z";
    }
    
    public Row getPlayerStats(String statsType) {
    ...
    public void printPlayerStats(Row row) {
        if (row != null) {
